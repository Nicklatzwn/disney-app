...
export const charactersMockData: IResponseCharacters = {
  info: {
    count: 50,
    totalPages: 149,
    previousPage: null,
  ...
  data: [
    ...
    },
    {
      ...
      shortFilms: [],
      tvShows: [],
      videoGames: ['The Haunted Mansion (video game)', 'Kinect Disneyland Adventures', 'Disney Crossy Road'],
    ...
    },
    {
      ...
      shortFilms: [],
      tvShows: [],
      videoGames: ['Treasure Planet: Battle at Procyon', "Disney Sorcerer's Arena", 'Disney Heroes: Battle Mode'],
      parkAttractions: [],
      allies: [],
      enemies: [],
    ...
    {
      _id: 351,
      films: ["The Little Mermaid: Ariel's Beginning", 'The Little Mermaid (live-action film)'],
      shortFilms: [],
      tvShows: [],
      videoGames: [],
      parkAttractions: [],
